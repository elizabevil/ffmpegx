...
type DVD struct {
	Title typex.UI8 `json:"title" flag:"-title"`
	...
	ChapterStart typex.UI8 `json:"chapter_start" flag:"-chapter_start,1"`
	//The chapter, or PTT (part-of-title), number to start at. Not applicable to menus. Default is 1.

	ChapterEnd typex.UI8 `json:"chapter_end" flag:"-chapter_end"`
	...
	Angle typex.UI8 `json:"angle" flag:"-angle,1"`
	...
	Region typex.UI8 `json:"region" flag:"-region"`
	...
	Menu typex.UBool `json:"menu" flag:"-menu"`
	...
	Preindex typex.UBool `json:"preindex" flag:"-preindex"`
